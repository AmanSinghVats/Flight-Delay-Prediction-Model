...
def loadData():
    flights = pd.read_csv(r'C:/Users/DEEKSHA PANDEY/Downloads/flights.csv',dtype={'COLUMN_NAME_7': str, 'COLUMN_NAME_8': str},low_memory=False)
    airport = pd.read_csv(r'C:/Users/DEEKSHA PANDEY/Downloads/airports.csv')
